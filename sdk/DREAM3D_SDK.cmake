...
set(_data_volume "${DREAM3D_SDK_ROOT}/../DREAM3D_Data")
if(EXISTS ${_data_volume})
  set(DREAM3D_DATA_DIR "${_data_volume}" CACHE PATH "DREAM3D Data")
endif()
...
set(ITK_DIR "${DREAM3D_SDK_ROOT}/prefix-${CMAKE_BUILD_TYPE}/lib/cmake/ITK-4.9" CACHE PATH "")
